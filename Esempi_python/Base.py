...
#SFONDO GIOCO
bg_img = pygame.image.load("images/bg_img.jpeg")    # 1
bg_img = pygame.transform.scale(bg_img ,(x_SCHERMO,y_SCHERMO)) #2
# SE vuoi un colore unico Decommenta #1 e #2  e decommenta la riga 72 e commenta la 73.
